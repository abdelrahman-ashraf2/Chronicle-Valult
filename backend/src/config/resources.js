...
export const resources = {
  ...
  watches: {
    table: "Watches",
    id: "watch_id",
    createFields: ["brand_id", "movement_id", "user_id", "model_name", "serial_number", "production_year", "case_material", "watch_condition"],
    updateFields: ["brand_id", "movement_id", "user_id", "model_name", "serial_number", "production_year", "case_material", "watch_condition"],
    search: ["w.model_name", "w.serial_number", "w.production_year", "w.case_material", "w.watch_condition", "b.brand_name", "m.movement_name", "u.username", "o.organization_name"],
    ...
    select: "w.watch_id, w.organization_id, w.brand_id, w.movement_id, w.user_id, w.model_name, w.serial_number, w.production_year, w.case_material, w.watch_condition, b.brand_name, m.movement_name, u.username AS owner_username, o.organization_name",
    scope: watchScope,
    listRoles: ALL_AUTH_ROLES,
    getRoles: ALL_AUTH_ROLES,
